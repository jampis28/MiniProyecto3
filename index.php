            ...
            <div class="loginC">
                ...
                <div class="inputs">
                    <form action="/handle_db/login.php" method="post">
                        <div id="email">
                            <div class="form-floating mb-3 input-group mb-3" id="input_email">
                                <input class="form-control" id="floatingInput" type="email" name="email" placeholder="hola" aria-label="hola" aria-describedby="basic-addon2">
                        ...
                        <div class="btn_login">
                            <button class="btn_login1" type="submit">Login</button>
                        </div>
                    </form>
                    <div id="cambio_register">
                        ...
                        <div id="changepage">
                            <span>Don't have an account yet? <a href="/views/register.php">Register</a></span>
                        </div>
                    </div>
